...
export class EnhancedPlaywrightMCPServer {
  ...
  private setupTools(): void {
    ...
    // Element Interaction Tools (Legacy - 6 basic tools)
    const elementTools = createElementTools(this.playwrightService);
    
    // Comprehensive Element Tools (50+ advanced tools)
    const comprehensiveElementTools = createComprehensiveElementTools(this.playwrightService);

    // Register all tools
    const allTools = [...browserTools, ...pageTools, ...elementTools, ...comprehensiveElementTools];
